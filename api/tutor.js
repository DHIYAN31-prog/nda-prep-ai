...
const kb={
 ...
 polity:{name:"Polity",definition:"Indian Polity studies the Constitution, institutions, rights, duties and governance structure of India.",intuition:"Connect each institution to its constitutional role, powers, limits and relationship with other institutions.",formula:"Revise polity as institution → constitutional basis → power → limitation → example.",example:"Fundamental Rights are contained in Part III of the Constitution.",trap:"Confusing constitutional offices, Parts, Articles, powers and amendment procedures.",practice:"Which Part of the Constitution contains Fundamental Rights?",flash:["Constitution","Fundamental Rights","Parliament","Executive","Judiciary"]},
 economics:{name:"Economics",definition:"Economics studies production, prices, income, employment, money, banking and public policy.",intuition:"For an economic term ask what it measures, what causes it, who is affected and which institution/policy is involved.",formula:"Inflation = sustained rise in the general price level; GDP measures final goods and services produced within an economy.",example:"If the general price level rises persistently, the economy is experiencing inflation.",trap:"Mixing nominal and real values, confusing GDP with income of every individual, and confusing fiscal with monetary policy.",practice:"Which institution conducts monetary policy in India?",flash:["GDP","Inflation","Fiscal policy","Monetary policy","Banking"]},
 sociology:{name:"Sociology",definition:"Sociology systematically studies society, social relationships, institutions, groups and culture.",intuition:"Look at how people interact, how institutions shape behaviour, and how values and norms are learned and maintained.",formula:"Analyse a social issue using individual → group → institution → culture → social change.",example:"Family is a major social institution that shapes socialisation and relationships.",trap:"Confusing sociology with individual psychology or treating culture as only art or entertainment.",practice:"What does sociology primarily study?",flash:["Society","Culture","Socialisation","Institutions","Social change"]}
};
